...
def copy_small_objects(image_dir, label_dir, save_base_dir, save_crop_base_dir, save_annotation_base_dir):
    ...
    for idx, rescale_label in enumerate(rescale_labels):
        ...
        if is_small_object((rescale_label_height, rescale_label_width), thresh=64 * 64) and rescale_label[0] == '1':
